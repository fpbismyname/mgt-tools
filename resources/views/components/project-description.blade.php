...
<x-modal-popup title="Preview Image" modalName="editProject">
    ...
    <form action="{{ route('project.edit', $idProject) }}" method="POST"
            ...
            <div class="row">
                <div class="col">
                    <label for="business_process_model" class="form-label mb-1">Business Process
                        Model</label>
                    <input type="file" name="business_process_model" class="form-control " accept="image/*">
                </div>
                <div class="col">
        ...
        <div class="row py-4 text-center">
            <div class="col">
                <button type="submit" class="btn btn-warning"><i class="bi bi-pencil-fill me-2"></i>Edit
                    Project</button>
            </div>
        </div>
    </form>
