                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="col-1 text-end">
                                                        ...
                                                        @foreach ($useCaseActor as $uca)
                                                            <span class="my-1 {{ Str::of($uc->case_actor)->contains($uca->actor_name) ? 'badge text-bg-primary border border-4 border-primary-subtle' : '' }}">
                                                                                    ...
                                                                                    @foreach ($useCaseActor as $uca)
                                                                                        <div class="form-check">
                                                                                            <input
                                                                                                ...
                                                                                                type="checkbox"
                                                                                                name="case_actor[]"
                                                                                                value="{{ $uca->actor_name }}"><span class="badge text-bg-primary border border-4 border-primary-subtle">{{ $uca->actor_name }}</span></input>
                                                                                        </div>
                                                                                    @endforeach
                                                                                </div>
                                                                            </div>
