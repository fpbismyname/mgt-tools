                        ...
                        <div class="col-12 col-sm text-center text-sm-end">
                            <div class="container">
                                <div class="row justify-content-center justify-content-sm-end gap-2">
                                    <button class="col-auto btn btn-primary fs-6" data-bs-target="#legendaPC"
                                            ...
                                            @foreach ($functionalSolution as $sD)
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="col-2 text-center ">
                                                        <span class="{{ $sD->solution_clasification == "Critical" ? "badge ". $badgeColor[0] : ""}}
                                                            {{ $sD->solution_clasification == "Important" ? "badge ". $badgeColor[1] : ""}}
                                                            {{ $sD->solution_clasification == "Useful" ? "badge ". $badgeColor[2] : ""}}
                                                            {{ $sD->solution_clasification ? "" : ""}}
                                                            ">{{ $sD->solution_clasification ?: '-' }}</span>
                                                    </td>
                                                                ...
                                                                <div class="row justify-content-center">
                                                                    <div class="container">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 mb-3">
                                                                                <label for="solution_clasification"
                                                                                    class="form-label mb-1">Request Clasification</label>
                                                                                <select name="solution_clasification"
                                                                                    class="form-select">
                                                                                    @foreach ($solutionClasification as $sc)
                                                                                        <option value="{{ Str::before(Str::words($sc->class_name, 1, ''), ".") }}">{{ Str::before(Str::words($sc->class_name, 1, ''), ".") }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
    ...
    <x-modal-popup title="Legenda Priority Clasification" modalName="legendaPC">
        ...
        <div class="container">
            <div class="row p-5 text-start gap-3">
                ...
                @foreach ($solutionClasification as $sc)
                    <div class="col-12">
                        <h5 class="fs-5 badge {{ $badgeColor[$badgeNumber++] }}">
                            {{ Str::before(Str::words($sc->class_name, 1, ''), '.')  }}</h5>
                        <p>{{ Str::after($sc->class_name, Str::words($sc->class_name, 1, '')) }}</p>
                    </div>
                @endforeach
            </div>
        </div>
